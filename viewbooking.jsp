...
<body>
<%ArrayList<ReservationBean> c=(ArrayList<ReservationBean>)request.getAttribute("vbb"); %>
<table border="4">
...
<%Iterator<ReservationBean> itr=c.iterator(); %>
<%while(itr.hasNext())
	{
	ReservationBean eb=(ReservationBean)itr.next();%>
