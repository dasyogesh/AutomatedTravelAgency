...
body{
	background-image: url("https://c.pxhere.com/photos/33/fa/fast_taxi_cab_kyoto_japan_moving_motion_speeding-717905.jpg!d");
 ...
 <div class="container">
 	<img class="profile-img"
		src="https://i.imgur.com/dGo8DOk.jpg" alt="">
          	       <marquee><label class="firstname">Success</label></marquee></div>
</body>		
</html>
