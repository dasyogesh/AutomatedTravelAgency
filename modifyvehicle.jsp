...
<body>
 <div class="container">
 <!---heading---->
     <header class="heading">Modify Vehicle</header><hr></hr>
	<!---Form starting----> 
	<form role="form" action="updatevehicle" id="abc"method="POST">
	<div class="row ">
	 <!--- For Name---->
         <div class="col-sm-12">
             <div class="row">
			     <div class="col-xs-4">
          	         <label class="firstname">Enter Vehicle ID :</label>
          	     </div>
		         <div class="col-xs-8">
		 ...
		 <div class="col-sm-12">
		     <div class="row">
			     <div class="col-xs-4">
		             <label class="firstname" >Enter new seating capacity:</label>
		             </div>
			     <div class="col-xs-8"	>	 
