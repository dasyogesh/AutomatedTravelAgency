...
body{
	background-image: url("http://contentools.com.br/wp-content/uploads/2017/04/Contentools.jpg");
...
<body>
 ...
 <!---heading---->
	...
	<!---Form starting----> 
	<form role="form" action="registerProfile" id="abc"method="POST">
	<div class="row ">
	 <!--- For Name---->
         <div class="col-sm-12">
             <div class="row">
		...
		<div class="col-sm-12">
		     <div class="row">
			     <div class="col-xs-4">
		             <label class="mail" >Last name:</label></div>
			     <div class="col-xs-8"	>	 
		...
		<div class="col-sm-12">
		     <div class="row">
			     <div class="col-xs-4">
		             <label class="mail" >Date of Birth:</label></div>
			     <div class="col-xs-8"	>	 
		...
		<div class="col-sm-12">
		     <div class="row">
			     <div class="col-xs-4">
		             <label class="mail" >Gender:</label></div>
			     <div class="col-xs-8"	>	 
			          <input type="text" name="gender" placeholder="Enter M/F" class="form-control" >
		         </div>
		     </div>
		 </div>
		 	 <br/><br/>
		...
		<div class="col-sm-12">
		     <div class="row">
			     <div class="col-xs-4">
		             <label class="mail" >Location:</label></div>
			     <div class="col-xs-8"	>	 
		...
		<div class="col-sm-12">
		     <div class="row">
			     ...
			     <div class="col-xs-8"	>	 
			          <input type="text" name="mobileno" placeholder="Enter 10-digit mobile number" class="form-control" >
		         </div>
		     </div>
		 </div>
		 	 <br/><br/>
		<div class="col-sm-12">
		     ...
		     <div class="form-control">
							<input type="submit" class="btn btn-lg btn-primary btn-block" value="Sign Up" onclick="func()">
			</div>
		   </form>
		 </div>
