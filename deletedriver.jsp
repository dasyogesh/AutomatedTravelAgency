...
<body>
 <div class="container">
 <!---heading---->
     <header class="heading">Delete Driver</header><hr></hr>
	<!---Form starting----> 
	<form role="form" action="removedriver" id="abc"method="POST">
	<div class="row ">
	 <!--- For Name---->
         <div class="col-sm-12">
             <div class="row">
			     <div class="col-xs-4">
          	         <label class="firstname">Enter Driver ID :</label> </div>
		         <div class="col-xs-8">
		             <input type="text" name="DRIVERID" placeholder="Enter driver's ID" class="form-control ">
             </div>
		      </div>
		 </div>
		  	 </div>
		     ...
		     <div class="form-control">
							<input type="submit" class="btn btn-lg btn-primary btn-block" value="Delete" onclick="func()">
			</div>
		   </form>
		 </div>
